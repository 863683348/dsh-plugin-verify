  ...
  ctx.tools.register(defineTool({
    ...
    execute: async (args, exec) => {
      ...
      if (action === "claim") {
        ...
        const rootSpec = String(args.scope || "").trim() || (cwd || ".");
        ...
        return {
          action: "claim",
          ok: result.verdict !== "unsupported",
          detail: "claim evidence check across " + filesScanned + " files",
          verdict: result.verdict,
          score: result.pct,
          summary: { found: result.foundCount, total: result.totalCount, pct: result.pct },
          evidence,
        };
      }
